        ...
        <div className="w-full mx-auto max-w-7xl">
            <aside className="relative mx-2 overflow-hidden text-black rounded-lg sm:mx-16 sm:py-16">
                <div className="relative z-10 max-w-screen-xl px-4 pt-10 pb-20 mx-auto sm:py-24 sm:px-6 lg:px-8">
                    <div className="max-w-xl space-y-8 text-center sm:mt-1 mt-80 sm:text-right sm:ml-auto">
                        <h2 className="text-4xl font-bold sm:text-5xl">
                            Download Now
                            <span className="hidden text-4xl sm:block">1B+ Downloads</span>
                        </h2>
                        ...
                        >
                            <svg
                                ...
                                width="24"
                                height="24"
                                xmlns="https://www.svgrepo.com/show/13529/racing-car-with-side-skirts.svg"
                                fillRule="evenodd"
                                clipRule="evenodd"
                            >
                ...
                <div className="absolute inset-0 w-full h-full pt-12 sm:my-20 sm:pt-1 ">
                    <img className="w-96" src="https://images.pexels.com/photos/1485894/pexels-photo-1485894.jpeg?auto=compress&cs=tinysrgb&w=600" alt="image1" />
                </div>
            </aside>

            <div className="grid place-items-center sm:mt-20">
                <img className="w-48 sm:w-96" src="https://images.pexels.com/photos/31909828/pexels-photo-31909828/free-photo-of-speeding-gold-sports-car-on-scenic-drive.jpeg?auto=compress&cs=tinysrgb&w=600" alt="image2" />
            </div>
